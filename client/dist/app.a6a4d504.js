...
var newMovie = function newMovie() {
  $(document).on('submit, "form#form-movie', function (e) {
    e.preventDefault();
    ...
    var response = $.ajax({
      ...
      console.log("This is the response I get back!: ".concat(data));
    });
  });
  return form;
};
...
$("body").prepend((0, _newMovie.default)());
},{"./newMovie":"src/newMovie.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
